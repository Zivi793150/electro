      ...
      <section className="main-maket-section">
        <div className="main-maket-container">
          ...
          <div className="main-maket-right">
            ...
            <div className="main-maket-text">Официальная продукция с гарантией 12 месяцев, консультации, поддержка, гибкие условия для оптовиков и компаний. В нашем каталоге широкий выбор дрели, перфораторы, болгарки, шуруповёрты, пилы, шлифмашины, измерительные приборы и комплектующие. Поставляем электроинструмент для частных клиентов, строительных организаций, снабженцев и тендерных закупок.</div>
